...
# plt.errorbar(date_list, mean, std, errorevery=(0,10),fmt='o',color="#023047")
...
#     temp_model = []
#     for t in range(len(time)):
#         temp_model_data=coeffs[0]*t**4+coeffs[1]**3+coeffs[2]**2+coeffs[3]*t+coeffs[4]
#         temp_model.append(temp_model_data)
#
#     # Plot the original temperature data
#     plt.plot(time, temp_list, label=f"temperature{i}", c=c[i - 1])
#     plt.plot(time, temp_model, label=f"temperature quartic model{i} T(t) ={coeffs[0]:.2f}^2+{coeffs[1]:.2f}t+{coeffs[2]:.2f}", c=c[i - 1], linestyle='--')
#
#     #r square value
#     r2=metrics.r2_score(temp_list, temp_model)
#     print(f"temp{i} r2 value: {r2}")
...
# plt.xlabel("time", fontsize=20)
# plt.ylabel("temperature (C)", fontsize=20)
# plt.title("temperature quartic model", fontsize=40)
# plt.legend(fontsize=15, loc="upper right")
#
#
# plt.subplot(2,1,2)
...
#     humid_model = []
#     for t in range(len(time)):
#         humid_model_data = coeffs[0]*t**4+coeffs[1]**3+coeffs[2]**2+coeffs[3]*t+coeffs[4]
#         humid_model.append(humid_model_data)
#
#     # Plot the original temperature data
#     plt.plot(time, humid_list, label=f"humidity{i}", c=c[i - 1])
#     plt.plot(time, humid_model, label=f"humidity_model{i} T(t) ={coeffs[0]:.2f}t^4+{coeffs[1]:.2f}t^3+{coeffs[2]:.2f}^2+{coeffs[3]:.2f}t+{coeffs[4]:.2f}", c=c[i - 1], linestyle='--')
#
#     # r square value
#     r2 = metrics.r2_score(humid_list, humid_model)
#     print(f"humid{i} r2 value: {r2}")
...
# plt.xlabel("time", fontsize=20)
# plt.ylabel("humidity (%)", fontsize=20)
# plt.title("humidity quartic model", fontsize=40)
# plt.legend(fontsize=15, loc="upper right")
#
# plt.show()
#endregion

#region #prediction quartic
# t=time[-1]
# future_time=time[:]
# print(t)
# for i in range(144):
...
#     f_temp_model = []
#     for t in range(len(future_time)):
#         f_temp_model_data=coeffs[0]*t**4+coeffs[1]**3+coeffs[2]**2+coeffs[3]*t+coeffs[4]
#         f_temp_model.append(f_temp_model_data)
#
#     # Plot the function
#     plt.plot(time,temp_list,label=f"temperature{i}", c=c[i - 1])
#     plt.plot(future_time[len(time):], f_temp_model[len(time):], label=f"temperature quartic prediction{i} T(t) ={coeffs[0]:.2f}^2+{coeffs[1]:.2f}t+{coeffs[2]:.2f}", c=c[i - 1], linestyle='--')
#
# current_date = date_list[-1]
# future_dates = [current_date + timedelta(minutes=i*5) for i in range(1, 145)]
# future_dates = date_list+future_dates
...
# plt.xlabel("time", fontsize=20)
# plt.ylabel("temperature (C)", fontsize=20)
# plt.title("temperature quatric prediction", fontsize=30)
...
#     f_humid_model = []
#     for t in range(len(future_time)):
#         f_humid_model_data = coeffs[0]*t**4+coeffs[1]**3+coeffs[2]**2+coeffs[3]*t+coeffs[4]
#         f_humid_model.append(f_humid_model_data)
#
#     # Plot the original temperature data
#     plt.plot(time, humid_list, label=f"humidity{i}", c=c[i - 1])
#     plt.plot(future_time[len(time):], f_humid_model[len(time):], label=f"humidity quatric prediction{i} T(t) ={coeffs[0]:.2f}t^4+{coeffs[1]:.2f}t^3+{coeffs[2]:.2f}^2+{coeffs[3]:.2f}t+{coeffs[4]:.2f}", c=c[i - 1], linestyle='--')
#
# plt.xticks(ticks, labels, fontsize=15, rotation=45, ha='right')
# plt.yticks(fontsize=15)
# plt.xlabel("time", fontsize=20)
# plt.ylabel("humidity (%)", fontsize=20)
# plt.title("humidity quatric prediction", fontsize=30)
# plt.legend(fontsize=15, loc="upper right")
#
# plt.show()
#endregion
...
# plt.xlabel("time", fontsize=20)
# plt.ylabel("temperature (C)", fontsize=20)
# plt.title("temperature quadratic model", fontsize=30)
# plt.legend(fontsize=15, loc="upper right")
#
#
# plt.subplot(2,1,2)
...
# plt.xlabel("time", fontsize=20)
# plt.ylabel("humidity (%)", fontsize=20)
# plt.title("humidity quadratic model", fontsize=30)
# plt.legend(fontsize=15, loc="upper right")
#
# plt.show()
#endregion
...
# plt.plot(date_list, fitted_temp1, label=f"Predict temperature1 T(t) ={c_temp1[0]:.2f}^2+{c_temp1[1]:.2f}t+{c_temp1[2]:.2f}", linestyle='--', c=c[0])
# plt.plot(date_list, fitted_temp2, label=f"Predict temperature2 T(t) ={c_temp2[0]:.2f}^2+{c_temp2[1]:.2f}t+{c_temp2[2]:.2f}", linestyle='--', c=c[1])
# plt.plot(date_list, fitted_temp3, label=f"Predict temperature3 T(t) ={c_temp3[0]:.2f}^2+{c_temp3[1]:.2f}t+{c_temp3[2]:.2f}", linestyle='--', c=c[2])
#
...
#
# # Plot the fitted temperature data
# plt.plot(date_list, fitted_humid1, label=f"Predict humid1 H(t) ={c_humid1[0]:.2f}^2+{c_humid1[1]:.2f}t+{c_humid1[2]:.2f}", linestyle='--', c=c[0])
# plt.plot(date_list, fitted_humid2, label=f"Predict humid2 H(t) ={c_humid2[0]:.2f}^2+{c_humid2[1]:.2f}t+{c_humid2[2]:.2f}", linestyle='--', c=c[1])
# plt.plot(date_list, fitted_humid3, label=f"Predict humid3 H(t) ={c_humid3[0]:.2f}^2+{c_humid3[1]:.2f}t+{c_humid3[2]:.2f}", linestyle='--', c=c[2])
#
# r2_1 = metrics.r2_score(temp_list, fitted_temp1)
...
# region # model quatric by using polyval
# fig = plt.figure (figsize=(40,20))
# plt.subplots_adjust(hspace=0.5)
# plt.subplot(2,1,1)
# temp_coeffs = []
...
# plt.xlabel("time",fontsize=20)
# plt.ylabel("temperature (C)", fontsize=20)
# plt.title("temperature quatric model", fontsize=40)
# plt.legend(fontsize=15, loc='upper right', ncol=3)
#
#
# plt.subplot(2,1,2)
...
# plt.xticks(ticks, labels, fontsize=15, rotation=45, ha='right')
# plt.yticks(fontsize=15)
# plt.title("humidity quatric model", fontsize=40)
# plt.xlabel("time",fontsize=20)
# plt.ylabel("humidity (%)", fontsize=20)
# plt.legend(fontsize=15, loc='upper right', ncol=3)
#
...
plt.xlabel("time", fontsize=20)
plt.ylabel("temperature (C)", fontsize=20)
plt.title("temperature quatric prediction", fontsize=40)
plt.legend(fontsize=15, loc='upper right', ncol=3)
# plt.legend(fontsize=20, loc='upper center', bbox_to_anchor=(.5, -.15), ncol=3)
...
plt.xticks(ticks, labels, fontsize=15, rotation=45, ha='right')
plt.yticks(fontsize=15)
plt.title("humidity quatric prediction", fontsize=40)
plt.xlabel("time", fontsize=20)
plt.ylabel("humidity (%)", fontsize=20)
plt.legend(fontsize=15, loc='upper right', ncol=3)
plt.tight_layout()
