...
**Fig.7** shows the flow diagram for plotting `t1` against time as a subplot for a figure. This program can be repeated for all the other variables, changing the value of the subplot being worked on, and the x values being plotted.
...
The video can be found under the name "Project 2- Weather Station.mp4" in this Google Drive Folder: 
